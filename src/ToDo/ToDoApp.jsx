...
export default function ToDoApp(){
    ...
    return(
        <>
        <div className="relative h-[70vh] w-[22vw]">
            ...
            <div className="flex flex-col items-center justify-start relative max-h-[70vh] w-[22vw] z-40 bg-alpha-50 border border-blue-20 backdrop-blur-[20px] rounded-2xl p-4 scroll-y overflow-y-scroll">
